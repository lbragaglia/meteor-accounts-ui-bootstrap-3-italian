(function() {
    ...
    Accounts._loginButtons.validateUsername = function(username) {
        if (username.length >= 3) {
            ...
            loginButtonsSession.errorMessage("Lo username deve essere di almeno 3 caratteri");
            return false;
        }
    };
    Accounts._loginButtons.validateEmail = function(email) {
        ...
        if (re.test(email)) {
            ...
            loginButtonsSession.errorMessage("Indirizzo email invalido");
            return false;
        }
    };
    Accounts._loginButtons.validatePassword = function(password) {
        if (password.length >= 6) {
            ...
            loginButtonsSession.errorMessage("La password deve essere di almeno 6 caratteri");
            return false;
        }
    };
